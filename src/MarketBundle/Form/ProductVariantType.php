...
class ProductVariantType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add('name', TextType::class, array('label' => 'Nom', 'attr' => array('class' => 'form-control')))
                ...
                ->add('product', EntityType::class, array('label' => 'Sélectionnez un produit', 'class' => 'MarketBundle:Product', 'choice_label' => 'name', 'attr' => array('class' => 'form-control')))        
        ;
    }
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'MarketBundle\Entity\ProductVariant'
        ));
    }
    ...
    {
        return 'marketbundle_productvariant';
    }
