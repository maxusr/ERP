...
class ContratType extends AbstractType
{
    ...
    {
        $builder
            ->add('type', ChoiceType::class, array('label' =>'Type de contrat', 'required' => true, 'expanded' => true, 'multiple' => false,'attr' => array('class' => 'checkboxes', 'placeholder' => 'Type de contrat...'), 'choices' => Contrat::TYPES))
