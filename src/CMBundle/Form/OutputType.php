...
class OutputType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('employeeBorrower', EntityType::class, array('required' => false, 'class' => 'CoreBundle:User', 'choice_label' => 'longname', 'label' => 'Employé emprunteur', 'attr' => array('class' => 'form-control')))
            ->add('borrower', BorrowerType::class, array('required' => false, 'label' => 'Emprunteur'))
        ;
    }
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'CMBundle\Entity\Output'
        ));
    }
}
