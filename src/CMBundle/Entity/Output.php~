 ...
 * @ORM\Entity(repositoryClass="CMBundle\Repository\OutputRepository")
...
class Output
{
     ...
     * @var Product
     *
     * @ORM\ManyToOne(targetEntity="Product", inversedBy="outputs")
     */
    private $product;
     ...
     * @var Borrower
     *
     * @ORM\OneToOne(targetEntity="Borrower", inversedBy="output", cascade={"persist", "remove"})
